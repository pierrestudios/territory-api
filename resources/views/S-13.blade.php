...
.record-entry table tr td {
    border-top: 1px solid #333;
    border-right: 1px solid #333;
    padding: 5px;
    font-size: 10px;
}
.record-entry table tr td .pub-name {
	overflow: hidden;
    width: 130px;
    height: 15px;
    font-size: 12px;
...
<div id="header">
	 <strong>Territory Assignment Record</strong>
</div>
...
<div class="main-content">
	...
	@if($recordsData)
	<div class="terr-column">
		<table>
	        <tr> 
				@foreach($recordsData as $inx => $terrData)
			    <?php 
				    $columnCount++; 
				    $newPage = (($columnCount % $columnLimit) === 0 && $columnCount >= $columnLimit);
			    ?>
			    
	            <td>
	                <div class="column-headers">
	                    <span class="terr-number">Terr No.</span>
	                    <span class="terr-number">{{$terrData->number}}</span>
	                </div>
	                
	                <div class="terr-records">
		                @foreach($terrData->records as $record)
	                    <div class="record-entry">
	                        <table>
	                            <tr>
	                                <td colspan="2">
		                                <div class="pub-name">{{$record->publisher}}</div>
		                            </td>
	                            </tr>
	                            <tr>

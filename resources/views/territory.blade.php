...
tr.list_row>td, .list tr.head td {
    font-size: 0.70em;
    padding: 3px;
}
>>>>>>> 604ed122cd6a3bad5bac5b142918b8f712b70c48
...
<table style="width: 100%" class="header">
	<tr>
		<td style="width: 100%; vertical-align: middle; padding: 10px">
			<h1 style="text-align: left">TERRITORY # <strong class="number">{{$number}}</strong>    {{$location}}</h1>
		</td>
	</tr>
</table>
...
<table class="detail" style="margin: 0px; border-top: none;">
	<tr>
		<td colspan="4" class="field">Symbol</td>
	</tr>	
	<tr>
		<td class="label" style="padding:0 10px"><strong>G:</strong> Gason</td>
		<td class="label"><strong>F:</strong> Fi</td>
...
<table class="detail" style="border-top: none; margin: 0px 0px 1.5em 0px; display: none">
<tr>
...
<table class="list" style="width: 100% margin-top: 1em;">
	...
	<tr class="foot">
		<td colspan="3" class="right">
			<strong>Total adrès:</strong>
		</td>
		<td class="right" colspan="4" style="font-weight: bold">43</td>
	</tr>

...
<head>
    ...
    <link rel="stylesheet" href="/spa/css/bootstrap.superhero.min.css">
    <link rel="stylesheet" href="/spa/lib/loading-bar.css">
...
<body ng-app="app">
    ...
    <script src="/spa/lib/ngStorage.js"></script>
    <script src="/spa/lib/loading-bar.js"></script>
    <script src="/spa/scripts/app.js"></script>
    <script src="/spa/scripts/controllers.js"></script>
    <script src="/spa/scripts/services.js"></script>
</body>
</html>